...
This blog post was originally written in 2015 - I'm just migrating it here now. I have not looked at any of this since then - but it's been fun to go through this again.  

**Warning**: This is long post.  The big picture can be gotten from the first few paragraphs. After that, I dive into all the various functions I wrote to solve apportionment problems as applied to US government.
...
The [apportR](https://github.com/jalapic/apportR) package was therefore my way of collating all the various methods that have been proposed to solve this problem.  And it turned out there are an annoyingly large number of methods.
